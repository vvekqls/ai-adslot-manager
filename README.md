...
- **Article experience** built with Next.js 15, React 18, TailwindCSS, Zustand, and shadcn/ui components. Slots reserve layout space to keep CLS near zero while a mock Prebid.js adapter asynchronously serves ads with a graceful fallback.
